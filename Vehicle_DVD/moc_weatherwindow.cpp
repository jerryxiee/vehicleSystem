...
QT_MOC_LITERAL(3, 44, 13), // "replyFinished"
QT_MOC_LITERAL(4, 58, 14) // "QNetworkReply*"

    },
    "WeatherWindow\0on_commandLinkButton_clicked\0"
    "\0replyFinished\0QNetworkReply*"
};
...
const QMetaObject WeatherWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_WeatherWindow.data,
      qt_meta_data_WeatherWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WeatherWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WeatherWindow.stringdata0))
        return static_cast<void*>(const_cast< WeatherWindow*>(this));
